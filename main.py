...
from routers import products, contact, currency, payment, webpay # Importa los routers de la aplicación
from database import engine # Importa el motor de la base de datos
from routers import payment # Importa el router de pagos
...
app.include_router(payment.router, prefix="/pagos", tags=["Pagos"]) # Incluye el router de pagos
